...
# Default Red
light_color = np.array([112,78,147])
dark_color = np.array([179,160,255])

# Purple
##light_color = np.array([140,71,78])
##dark_color = np.array([179,245,255])

# Yellow (both Deuteranopia and Protanopia)
##light_color = np.array([80,88,217])
##dark_color = np.array([91,224,255])
